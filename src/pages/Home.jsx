...
const Home = () => {
  ...
  return (
    <div className="bg-brand-ivory min-h-screen relative overflow-hidden pb-12">
      ...
      <section className="py-20 px-6 md:px-12 bg-white relative border-b border-brand-gold/15">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedWrapper delay={0.2} className="relative aspect-[4/5] overflow-hidden border border-brand-gold/25 gold-shadow max-w-sm mx-auto lg:max-w-none">
            <img 
          ...
          <AnimatedWrapper delay={0.4} className="space-y-6 text-center lg:text-left">
            <span className="font-signature text-3xl md:text-4xl text-brand-gold block font-medium">
              Woven by Divine Hands
            </span>
            <h2 className="font-cinzel text-2xl md:text-4xl text-brand-maroon tracking-widest font-semibold uppercase leading-snug">
              The Legend of Balaramapuram
            </h2>
            <div className="w-16 h-[2px] bg-brand-gold my-4 mx-auto lg:mx-0"></div>
            ...
            <div className="pt-4">
              <LuxuryButton variant="secondary" onClick={() => navigate('/about')}>
                Read Our Legacy
              </LuxuryButton>
            </div>
          </AnimatedWrapper>
      ...
      <section className="w-full py-28 relative bg-cover bg-center overflow-hidden border-t border-b border-brand-gold/30" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&q=80&w=1920')` }}>
        {/* Dark Tint overlay */}
        <div className="absolute inset-0 bg-brand-maroon/75 backdrop-blur-[1px]"></div>
        
        {/* Decorative corner highlights */}
        <div className="absolute top-6 left-6 right-6 bottom-6 border border-brand-gold/15 pointer-events-none"></div>

        <div className="max-w-3xl mx-auto text-center relative z-10 px-4 space-y-6">
          <span className="font-signature text-3xl md:text-5xl text-brand-gold block font-medium">
            Bridal Couture
          </span>
          <h2 className="font-cinzel text-3xl md:text-5xl text-brand-ivory tracking-widest font-semibold uppercase leading-tight">
          ...
          <div className="pt-4 flex flex-wrap justify-center gap-4">
            <LuxuryButton variant="gold" onClick={() => navigate('/shop?category=bridal-wear')}>
              View Bridal Catalog
            </LuxuryButton>
            ...
            <a
              ...
              className="px-8 py-3.5 bg-emerald-800 hover:bg-emerald-900 border border-brand-gold font-cinzel text-xs md:text-sm tracking-widest font-semibold uppercase transition-all duration-300 text-white"
            >
      ...
      <section className="py-20 bg-white border-t border-b border-brand-gold/15 px-4 md:px-12">
          ...
          <AnimatedWrapper>
            <div className="flex flex-col md:flex-row items-center justify-between mb-12">
              <div className="text-center md:text-left mb-6 md:mb-0">
                ...
                <h2 className="font-cinzel text-2xl md:text-3xl text-brand-maroon tracking-wider font-semibold uppercase">
                  Reels in Motion
                </h2>
              </div>
